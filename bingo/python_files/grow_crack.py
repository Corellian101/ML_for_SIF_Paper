...
for a in A:
    ...
    for c in C:
        for h in H:
            ...
            dir = 'ac'+str(round(a/c,2))+'_at'+str(round(a/t,2))+'_rad'+str(round(rad,3))+'_refine'+str(round(h,3))
            ...
            np.savetxt('/uufs/chpc.utah.edu/common/home/u1155988/data/'+dir+'.csv',F_datatable)
            #plt.figure()
